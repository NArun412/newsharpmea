...
<?php if($this->users_m->check_user_record_access($this->module,$this->id,$this->user_info)) {?>
	...
	?>
    	<li role="presentation" <?php if($this->router->method == 'translation') {?>class="active"<?php }?>><a href="<?php echo admin_url("manage/mod/".$this->module."/".$this->id."/".$con['name']); ?>"><?php echo display_field_name(ucfirst($con['name'])); ?></a></li>
    <?php 
			}}
	}?>
...
<div class="row">
<div class="<?php if($this->translate_lang == '') {?>col-md-12<?php } else {?>col-md-6<?php }?>">
<?php 
if(!isset($info)) $info = array();
$this->load->view($this->admin_dir."/fields/table-translate",array("info"=>$info,"content_type"=>$this->module)); ?>
</div>
<?php if($this->translate_lang != '') {?>
<div class="col-md-6">
<?php 
$this->load->view($this->admin_dir."/fields/form-translate",array("info"=>$info,"content_type"=>$this->module)); ?>
</div>
<?php }?>
</div>
</div>
