...
<section id="header">
                <header class="clearfix">
                    ...
                    <!-- Branding -->
                    <div class="branding">
                        <a class="brand" href="<?php echo admin_url('dashboard'); ?>">
                            <span><strong>
								<?php
								//$this->settings = $this->session->userdata('settings');
								echo $this->settings["website_title"];
								?>
                            </strong></span>
                        </a>
                            ...
                            <div class="dropdown-menu pull-right with-arrow panel panel-default animated littleFadeInUp" role="menu">
                                ...
                                <ul class="list-group">
                                    ...
                                    <li class="list-group-item">
                                        <a role="button" tabindex="0" class="media">
                                            <span class="pull-left media-object thumb thumb-sm">
                                                <img src="<?php echo base_url(); ?>assets/images/arnold-avatar.jpg" alt="" class="img-circle">
                                            </span>
                                    ...
                                    <li class="list-group-item">
                                        <a role="button" tabindex="0" class="media">
                                            <span class="pull-left media-object  thumb thumb-sm">
                                                <img src="<?php echo base_url(); ?>assets/images/george-avatar.jpg" alt="" class="img-circle">
                                            </span>
                                            <div class="media-body">
					...
					-->
                        <li class="dropdown nav-profile" style=" margin-right:25px">
<?php $photo = user_photo(); ?>
                            <a href class="dropdown-toggle" data-toggle="dropdown">
                            	<?php if(!empty($photo) && file_exists('./uploads/users/'.$photo)){ ?>
                                <img src="<?php echo base_url(); ?>uploads/users/<?php echo $photo; ?>" alt="" class="img-circle size-30x30">
                                <?php } ?>
                                <span><?php echo user_name(); ?> <i class="fa fa-angle-down"></i></span>
                            </a>

                            <ul class="dropdown-menu animated littleFadeInRight" role="menu">

                                <li>
                                    <a href="<?php echo admin_url('profile'); ?>" role="button" tabindex="0">
                                ...
                                <li>
                                    <a href="<?php echo admin_url('settings'); ?>" role="button" tabindex="0">
                                ...
                                -->
                                <li>
                                    <a href="<?php echo admin_url('login/logout'); ?>" role="button" tabindex="0">
