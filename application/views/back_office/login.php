...
if($this->session->flashdata('login_error') != ""){
	echo '<p>'.$this->session->flashdata('login_error').'</p>' ;
      ...
      <?php } ?>
      <?php echo form_open(admin_url('login/login_validate'),array(
	  	"name"=>"form",
		"method"=>"post",
        ...
        <div class="form-group">
          <input type="password" placeholder="Password" name="pass" value="<?= set_value('pass'); ?>" class="form-control underline-input" />
        </div>
        ...
        <!--  <label class="checkbox checkbox-custom-alt checkbox-custom-sm inline-block">
          ...
          <a href="<?php echo admin_url("login/password"); ?>" class="pull-right mt-10">Forgot Password?</a> </div>
     <?php echo form_close(); ?>
    </div>
  </div>
</div>
