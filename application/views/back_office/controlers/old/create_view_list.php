...
window.location="<?= base_url(); ?>back_office/'.$table_name.'/delete/"+id;
return false;
}
...
$list_view.='
<td><input type="text" name="search" class="search_box" id="'.$str_replace.'_search" /></td>';	
}
$list_view.='
<td></td>
</tr>
...
if($gallery_status == 1){
$list_view.='<li><a href="<?= base_url(); ?>back_office/control/manage_gallery/'.$content_name.'/<?= $val["id_'.$table_name.'"] ?>" title="Add Photos">
<i class="icon-film"></i> Manage Gallery</a></li>';
}
if($multi_languages == 1){ 
$list_view.='<li><a href="<?= base_url(); ?>back_office/'.$content_name.'/translate/<?= $val["id_'.$table_name.'"] ?>">
Translate</a></li>';
}
$list_view.='
<? if ($this->acl->has_permission(\''.$table_name.'\',\'index\')){ ?>
<li><a href="<?= site_url(\'back_office/'.$table_name.'/view/\'.$val["id_'.$table_name.'"]);?>" class="table-edit-link">
View</a></li>
<? } ?>
<? if ($this->acl->has_permission(\''.$table_name.'\',\'edit\')){ ?>
<li>
<a href="<?= site_url(\'back_office/'.$table_name.'/edit/\'.$val["id_'.$table_name.'"]);?>" class="table-edit-link" >
Edit</a></li>
<? } ?>
<? if ($this->acl->has_permission(\''.$table_name.'\',\'delete\')){ ?>
<li>
<a onclick="if(confirm(\'Are you sure you want delete this item ?\')){ delete_row(\'<?=$val["id_'.$table_name.'"];?>\'); }" class="table-delete-link cur">
Delete</a></li>
<? } ?>
</ul>
</div>
