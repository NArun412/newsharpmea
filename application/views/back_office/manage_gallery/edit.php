...
echo form_open_multipart('back_office/control/edit_photo_submit', $attributes); 
?>
<section class="tile">
...
<input type="file"  name="image" data-buttonText="Find file" data-iconName= "fa fa-inbox" class="filestyle"  />
<span >
<?
if($info["image"] != ""){ ?>	
...
&nbsp;&nbsp;&nbsp;
<a class="cur" onclick="if(confirm('Are you sure you want to delete this image ?')){ window.location=' <?= base_url(); ?>back_office/control/delete_image_gallery/image/<?= $info["image"]; ?>/<?= $id_gallery; ?>/<?= $id; ?>/<?=$content_type;?>' } " >
