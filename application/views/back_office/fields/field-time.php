...
<?php }?>
<!--<div class="input-group  w-360 mt-10" data-format="L">-->
<?php
//echo form_input(array('name' => $fld, 'value' => dateformat(set_value($fld,$info[$fld]),"m/d/Y"),'class' => 'form-control','size'=>16 ));
echo form_input(array('name' => $fld, 'value' => set_value($fld,$info[$fld]),'class' => 'form-control timepicker','size'=>16 ));
?>
