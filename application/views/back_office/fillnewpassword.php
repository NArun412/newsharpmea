...
<div id="wrap" class="animsition">
  <div class="page page-core page-login">
    ...
    <div class="container w-420 p-15 bg-white mt-40 text-center">
      <h2 class="text-light text-greensea">Update Password</h2>
      <?php 
...
if($this->session->flashdata('login_error') != ""){
	echo '<p>'.$this->session->flashdata('login_error').'</p>' ;
      ...
      <?php } ?>
         ...
         <?php echo form_open(admin_url('login/update_password'),array(
	  	"name"=>"form",
		"method"=>"post",
		"class"=>"form-validation mt-20"
	  )); ?>
        <div class="form-group">
          <input type="password" class="form-control underline-input" name="password" value="<?= set_value('password'); ?>" placeholder="Password" />
        </div>
        <div class="form-group">
          <input type="confirm_password" class="form-control underline-input" name="confirm_password" value="<?= set_value('confirm_password'); ?>" placeholder="Confirm Password" />
        </div>
        <div class="form-group text-left mt-20"> 
          <!-- <a href="index.html" class="">Login</a> -->
          <input type="submit" class="btn btn-danger b-0 br-2 mr-5" value="Update Password" >
          </div>
    <?php echo form_close(); ?>
    </div>
  </div>
