...
window.onmousemove = function (e) {
    var x = e.clientX,
        y = e.clientY;
    $('.tooltip-span').css({'top':(y + 20) + 'px','margin-left':(x + 20) + 'px'});
};    
            ...
            <div id="banner_layer" >
                ...
                foreach ($banners as $banner) {
                    ...
                    if ((!empty($banner_img) && file_exists("./uploads/banner/" . $path . "/" . $banner_img))) {
                        ?>
                        <div>
                            <div class="relative  span <?php echo $banner['link'] != '' ? 'curPointer tooltip' : '' ?>"  >
                                <span class="<?php echo $banner['link'] != '' ? 'tooltip-span' : '' ?>"><?php echo $banner['link'] != '' ? $banner['link_label'] : '' ?></span>
