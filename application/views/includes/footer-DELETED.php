        ...
        <ul id="footer_ul">
          <li class="row-block">
            <ul class="footer_ul_sub first">
              ...
              <li><a href="<?php echo route_to('about/corporate_profile'); ?>" class="<?php if($method == "corporate_profile") echo 'active'; ?>" ><i class="fa fa-caret-<?php echo $cart_dir; ?>" aria-hidden="true"></i><?php echo lang("corporate profile"); ?></a></li>
