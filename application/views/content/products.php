        ...
        <div class="span">
            <div class="products-left">
                ...
                <div class="quick-search-form">
                    <?php
                    echo form_open($url, array("method" => "GET", "id" => "product_search_left"));
                    ...
                    <!--  	<label><?php echo lang("division"); ?></label>-->
                        ...
                        <ul class="left-menu">
                            ...
                            foreach ($all_divisions as $rec) {
                                $cl = '';
                                if (isset($division['id']) && $rec['id'] == $division['id'])
                                    $cl = 'checked="checked"';
                                ?>
                    ...
                    <?php
//foreach($all_products_lines as $rec) {
//$cl = '';
                ...
                if (!empty($products)) {
                    foreach ($products as $product) {
                        ...
                        <div class="product-box listing three">
                            ...
                            <h2 style="height: 47px;"><a title="<?php echo $product['title']; ?>" href="<?php echo $link; ?>"><?php echo $product['title']; ?></a></h2>
