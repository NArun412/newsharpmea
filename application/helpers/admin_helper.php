...
function check_approval($module,$record,$role)
{
	...
	$q = $CI->db->where(array(
		...
		"record"=>$record
		//$field=>1
	))->order_by('id DESC')->get("content_type_reviews");
	$check = $q->row_array();
	//print '<pre>';print_r($check);exit;
	if(!empty($check) && $check[$field] == 1) {
		//$res = $q->row_array();
		return true;
	}
	else {
...
function render_time($attr,$selected = '')
{
	$view = 'back_office/fields/field-time';
	if(file_exists('./application/views/back_office/fields/custom/field-time-'.$attr['table_name'].'-'.$attr['name'].'.php'))
	$view = 'back_office/fields/custom/field-time-'.$attr['table_name'].'-'.$attr['name'];
...
{
 //if($attr['name'] == 'image') {   print '<pre>'; print_r($attr); exit; }
...
function render_editor($attr,$selected = '')
{
	$view = 'back_office/fields/field-editor';
	if(file_exists('./application/views/back_office/fields/custom/field-textarea-'.$attr['table_name'].'-'.$attr['name'].'.php'))
	$view = 'back_office/fields/custom/field-textarea-'.$attr['table_name'].'-'.$attr['name'];
...
function render_email($attr,$selected = '')
{
	//print '<pre>'; print_r($attr); exit;
	$view = 'back_office/fields/field-email';
	if(file_exists('./application/views/back_office/fields/custom/field-email-'.$attr['table_name'].'-'.$attr['name'].'.php'))
	$view = 'back_office/fields/custom/field-email-'.$attr['table_name'].'-'.$attr['name'];
...
if ( ! function_exists('render_password')){
function render_password($attr,$selected = '')
{
	//print '<pre>'; print_r($attr); exit;
	$view = 'back_office/fields/field-password';
	if(file_exists('./application/views/back_office/fields/custom/field-password-'.$attr['table_name'].'-'.$attr['name'].'.php'))
	$view = 'back_office/fields/custom/field-password-'.$attr['table_name'].'-'.$attr['name'];
