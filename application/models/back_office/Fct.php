...
$config = array();
$config['allowed_types'] = 'jpg|jpeg|png|gif|txt|pdf|docx|doc|csv|avi|flv|wmv|mpeg|mp3|mp4|php|xml|java|html|PNG';
...
function move_to_trash($module,$data,$record = 0,$field_title = 'title')
{
	$title = '';
...
function insert_update_seo($module,$data,$record = 0)
{
