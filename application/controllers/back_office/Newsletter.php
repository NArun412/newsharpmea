...
redirect(base_url().'back_office/newsletter');
}
...
$email_from = $this->fct->getonecell('settings','email',$cond);
$website_title = $this->fct->getonecell('settings','website_title',$cond);
$emails = explode(',',$ids);
